...
#srun -J rando --mem 50000 -c 10 -w adamantium python3 sim999.py ./embeddings/top_10000_emb.txt Word2Vec
#srun -J rando --mem 50000 -c 10 -w adamantium python3 sim999.py ./embeddings/gigatext1.txt Word2Vec
#srun -J rando --mem 50000 -c 10 -w adamantium python3 sim999.py ./embeddings/GoogleNews-vectors-negative300.bin Word2Vec
...
srun -J rando --mem 50000 -c 10 -w adamantium python3 sim353.py ../embeddings/random__source--glove.840B.300d.word2vec__2019-01-03-1210.txt Word2Vec 
